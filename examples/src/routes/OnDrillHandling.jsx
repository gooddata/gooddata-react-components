...
import GeoPushpinChartDrillExampleSRC from "!raw-loader!../components/GeoPushpinChartDrillExample"; // eslint-disable-line import/no-webpack-loader-syntax, import/no-unresolved, import/extensions, import/first
...
export const OnDrillHandling = () => (
    <div>
        ...
        <h2 id="geo-pushpin-chart">GeoPushpin chart</h2>
        <ExampleWithSource for={GeoPushpinChartDrillExample} source={GeoPushpinChartDrillExampleSRC} />
    </div>
);
