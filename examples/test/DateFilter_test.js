...
test("Absolute date filter calendar appears when from field has focus", async () => {
    await DF.openAbsoluteFormFilter();
...
//   - range crossing
test("Absolute date filter selected from calendar", async () => {
...
test("Absolute date filter calendar - clicked days from outside month", async () => {
