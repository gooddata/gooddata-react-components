...
import { SyntaxHighlightingInput, ISyntaxHighlightingProps } from "../SyntaxHighlightingInput";
...
const defaultProps: ISyntaxHighlightingProps = {
    value: "",
    onChange: jest.fn(),
};
...
const renderComponent = (props?: Partial<ISyntaxHighlightingProps>) => {
...
describe("SyntaxHighlightingInput", () => {
    ...
    it("should render correct value and classname", () => {
        const props: ISyntaxHighlightingProps = {
            ...defaultProps,
