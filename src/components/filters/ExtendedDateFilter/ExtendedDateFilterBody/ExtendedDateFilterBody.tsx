...
import { getDateFilterOptionGranularity } from "../utils/dateFilterOptionUtils";
...
export interface IExtendedDateFilterBodyProps {
...
export interface IExtendedDateFilterBodyState {
...
export class ExtendedDateFilterBody extends React.Component<
    IExtendedDateFilterBodyProps,
    IExtendedDateFilterBodyState
> {
    public state: IExtendedDateFilterBodyState = {
        route: null,
    };

    public changeRoute = (route: IExtendedDateFilterBodyState["route"] = null) => {
        this.setState({ route });
    };
    ...
    private renderMobileContent() {
        ...
        if (route === "absoluteForm") {
            return (
                <>
                    <ExtendedDateFilterHeader changeRoute={this.changeRoute}>
                        <FormattedMessage id="filters.staticPeriod" />
                    </ExtendedDateFilterHeader>
