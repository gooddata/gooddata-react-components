...
export interface IFunnelChartProps extends ICommonChartProps {
    projectId: string;
}
...
export function FunnelChart(props: IFunnelChartProps): JSX.Element {
    ...
    const newProps
        = omit<IFunnelChartProps, IFunnelChartNonBucketProps>(props, ['measures', 'trendBy', 'segmentBy', 'filters']);
