...
describe("adjustTickAmount - detail", () => {
    ...
    describe("shouldBeHandledByHighcharts", () => {
        ...
        it("should line chart by custom behavior", () => {
            ...
            expect(shouldBeHandledByHighcharts(yAxis)).toBeFalsy();
        });

        it("should handle combo line-line chart  by custom behavior", () => {
            const yAxis = {
                coll: "yAxis",
                series: [
                    {
            ...
            expect(shouldBeHandledByHighcharts(yAxis as Partial<IHighchartsAxisExtend>)).toBeFalsy();
        });
