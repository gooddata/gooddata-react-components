...
describe("Table", () => {
    it("should render sortable table for dashboard environment", () => {
        const component = shallow(<Table environment="dashboards" dataSource={oneMeasureDataSource} />);

        expect(component.find(SortableTable)).toBeTruthy();
    });

    it('should render pure table for "none" environment', () => {
        const component = shallow(<Table environment="none" dataSource={oneMeasureDataSource} />);
