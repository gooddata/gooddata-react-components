...
describe('fixEmptyHeaderItems', () => {
    it('should handle missing headerItems', () => {
        ...
        delete missingHeaders.executionResult.headerItems;
    ...
    it('should replace empty values in all types of headerItems', () => {
        ...
        expect(fixed.executionResult.headerItems[1][0][1].attributeHeaderItem.name).toEqual(EMPTY_HEADER_STRING);
        expect(fixed.executionResult.headerItems[1][1][1].measureHeaderItem.name).toEqual(EMPTY_HEADER_STRING);
        expect(fixed.executionResult.headerItems[1][2][0].totalHeaderItem.name).toEqual(EMPTY_HEADER_STRING);
    });
});
