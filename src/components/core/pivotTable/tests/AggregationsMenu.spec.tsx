...
import { EXECUTION_RESPONSE_1A_2M } from '../../../visualizations/table/fixtures/1attribute2measures';
...
describe('AggregationsMenu', () => {
    ...
    it('should not render any submenu when there is only one row attribute', () => {
        const wrapper = render({
            showSubmenu: true ,
            getExecutionResponse: () => EXECUTION_RESPONSE_1A_2M
        });
