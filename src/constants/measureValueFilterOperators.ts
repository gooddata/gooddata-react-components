...
export const GREATER_THAN: AFM.ComparisonConditionOperator = "GREATER_THAN";
export const GREATER_THAN_OR_EQUAL_TO: AFM.ComparisonConditionOperator = "GREATER_THAN_OR_EQUAL_TO";
