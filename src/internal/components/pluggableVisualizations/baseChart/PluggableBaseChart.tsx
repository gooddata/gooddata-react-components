...
export const getCollapsedLegendPosition = (legendPosition: string) =>
    legendPosition === "bottom" ? "bottom" : "top";
...
export class PluggableBaseChart extends AbstractPluggableVisualization {
    ...
    private getLegendPosition(
        ...
        if (this.environment === DASHBOARDS_ENVIRONMENT) {
            return width <= getMaxWidthForCollapsedLegend(legendPosition)
                ? getCollapsedLegendPosition(legendPosition)
                : legendPosition;
        }
