...
interface ILineFamilyChartConfig {
    colours?: String[];
}
...
export class LineFamilyChart extends React.PureComponent<ILineFamilyChartProps, ILineFamilyChartState> {
    constructor(props) {
        super(props);
