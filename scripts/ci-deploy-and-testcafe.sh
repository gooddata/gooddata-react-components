...
heroku config:set EXAMPLE_MAPBOX_ACCESS_TOKEN=$MAPBOX_TOKEN DOMAIN_ADMIN_USERNAME=developer-domain@gooddata.com DOMAIN_ADMIN_PASSWORD=$LIVE_EXAMPLES_ADMIN_PASSWORD PROJECT_ID_TO_ASSIGN=xms7ga4tf3g3nzucd8380o2bev8oeknp > /dev/null
git remote -v
