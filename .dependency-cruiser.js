options = {
    forbidden: [
        ...
        {
            name: 'constants-encapsulated',
            comment: "The constants module must be encapsulated - it must not import from other modules.",
            severity: 'error',
            from: {
                path: "src/constants"
            },
        ...
        },
        {
            ...
            comment: "The interfaces module must only depend on itself, constants or errors.",
            severity: 'error',
            from: {
                path: "src/interfaces"
            },
            to: {
                pathNot: "^(src/interfaces|src/constants|src/errors)"
            }
        },
        {
            name: 'helpers-dependencies',
            comment: "The helpers module module only depend on itself, constants, interfaces or errors",
            severity: 'error',
            from: {
                path: "src/helpers"
            },
            to: {
                pathNot: "^(src/helpers|src/constants|src/interfaces|src/errors)"
            }
        },
        {
            name: 'components-are-toplevel',
            comment: "Charts and tables are top-level component. No other code should depend on them",
            severity: 'error',
            from: {
                pathNot: "^(src/index\.ts|src/components|src/internal/components)"
            },
            to: {
                path: "src/components"
            }
    ...
    options: {
        ...
        */
        doNotFollow: {
            path: '.*(node_modules|stories|tests|test|fixtures|translations|svg).*',
            dependencyTypes: [
                'npm',
                'npm-dev',
                'npm-optional',
