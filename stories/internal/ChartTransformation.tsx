...
class DynamicChart extends React.Component<any, any> {
    ...
    constructor(props: any) {
        ...
        this.chartTypes = ["column", "bar", "line", "pie", "heatmap"];
            ...
            <div>
                ...
                <div>
                    {Object.keys(this.fixtures).map(dataSetName => (
                        <button key={dataSetName} onClick={setDataSet(dataSetName)}>
                            {dataSetName}
                        </button>
                    ))}
                </div>
...
storiesOf("Internal/HighCharts/ChartTransformation", module)
                    ...
                    drillableItems={[
                        {
                            uri:
                                dataSet.executionResponse.dimensions[STACK_BY_DIMENSION_INDEX].headers[0]
                                    .measureGroupHeader.items[0].measureHeaderItem.uri,
                        },
                    ]}
                    config={{
                        type: "column",
            ...
            wrap(
                <ChartTransformation
                    drillableItems={[
                        {
                            uri:
                                dataSet.executionResponse.dimensions[VIEW_BY_DIMENSION_INDEX].headers[0]
                                    .attributeHeader.uri,
                        },
                    ]}
                    config={{
    ...
    .add("Pie chart view viewBy attribute with empty value", () => {
        const dataSet: any = immutableSet(
            fixtures.barChartWithViewByAttribute,
            "executionResult.data[0][0]",
            null,
        );
            ...
            wrap(
                <ChartTransformation
                    ...
                    drillableItems={[
                        {
                            uri:
                                dataSet.executionResult.headerItems[VIEW_BY_DIMENSION_INDEX][0][4]
                                    .attributeHeaderItem.uri,
                        },
                    ]}
                />,
    ...
    .add("Custom legend implementation", () => <CustomLegend />)
    .add("Dynamic Chart test", () => <DynamicChart />)
            ...
            wrap(
                <ChartTransformation
                    config={{
                        ...
                        secondary_yaxis: {
                            measures: [
                                "3b4fc6113ff9452da677ef7842e2302c",
                                "26843260d95c4c9fa0aecc996ffd7829",
                            ],
                        },
                    }}
                    {...fixtures.barChartWith4MetricsAndViewBy2Attribute}
